...
.leticia-site .projeto-placeholder { width:100%; aspect-ratio:3/4; height:auto; transition:filter 0.6s cubic-bezier(0.25,0.46,0.45,0.94), transform 0.6s ease; filter:grayscale(100%); background-size:contain !important; background-position:center !important; background-repeat:no-repeat !important; background-color:var(--beige); }
