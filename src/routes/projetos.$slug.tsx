...
const wrap: Record<string, React.CSSProperties> = {
  ...
  thumb: { aspectRatio: "4/3", backgroundSize: "contain", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundColor: "#ebe6dc", border: "1px solid #ddd8cf", cursor: "zoom-in", padding: 0, transition: "opacity 0.2s" },
