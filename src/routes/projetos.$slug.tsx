...
const wrap: Record<string, React.CSSProperties> = {
  ...
  grid: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 16, maxWidth: 1400, margin: "0 auto" },
  thumb: { aspectRatio: "4/3", backgroundSize: "contain", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundColor: "#ebe6dc", border: "none", cursor: "zoom-in", padding: 0, transition: "opacity 0.2s" },
